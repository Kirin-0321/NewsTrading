...
| 文档 | 角色 | 状态 |
|------|------|------|
| [盘后数据 GUI 优化效果方案](../doc/design/05-26-2116-盘后数据GUI优化效果方案.md) | **候选 #1（轻量）** — GUI 三层增强（A 必做 / B 建议 / C 选做），约 0.5~5 天 | 🟡 效果方案已完成，**待主人审稿勾选** |
...
盘后数据自动化
  ...
  ➕ GUI 优化（M6 候选）⚪ 0%
     ...
     A 字段补全（必做，~6h，完整度 60% → 85%）
     B 新增 Tab（建议，~2.5d，完整度 → 96%）
     C 交互下钻（选做，~2d，完整度 → 100%）
     待主人勾选 Level 组合后开工
