...
| 文档 | 角色 | 状态 |
|------|------|------|
| [⭐ 分析报告查看 & 预测板块体验优化·内容文档](../doc/design/05-29-1010-报告查看与预测板块体验优化设计.md) · [施工方案（第1+2批）](../doc/design/05-29-1025-报告查看与预测板块体验优化施工方案.md) | **主人通读版** — 块A 报告查看与联动（统一浏览/页内预览/精确跳转/数据管理页修目录）+ 块B 预测板块筛选查看（打分明细接通/筛选栏/板块中文名/阈值对齐/跨日总览/预测↔行情联动）；4 批次推进建议 + 10 个决策点。**主人已拍板采纳推荐勾法 + 先做第 1+2 批**（6 项：数据管理页修目录/阈值对齐/AI 页内预览/板块中文名/打分明细接通/评估页精确联动） | 🔵 **施工中**（Ph1~Ph5） |
