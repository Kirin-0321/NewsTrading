...
| 文档 | 角色 | 状态 |
|------|------|------|
| [⭐ 命中率与方向算法重设·剔除利空·题材排序设计](../doc/design/05-29-0058-命中率与方向算法重设与利空过滤设计.md) | **内容文档·主人通读版** — 利空全量剔除（强度≤0）+ 命中率新公式（α 自适应阈值 = 强度/20）+ 方向新公式（∏(1+r) > 1）+ 题材按强度 DESC 排序 + 历史数据整库清空 | 🟡 **等主人审**（通过后写施工方案） |
