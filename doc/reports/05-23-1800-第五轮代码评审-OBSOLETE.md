...
>
> 请改读现行版：
> - **[review_report_2.md](./05-26-2100-第六轮项目评审.md)** — 第六轮 review（2026-05-26 最新），发现 M0 实际只完成一半
> - [README.md](./README.md) — 项目文档总索引 + 当前进度
> - [架构方案.md](../design/05-26-2126-NewsTrading架构方案.md) — 三段式流水线 + §15 盘后数据模块
> - [盘后数据自动化-功能说明.md](../features/05-26-2126-盘后数据自动化功能说明.md) — 主人版
> - [盘后数据自动化-施工方案.md](../design/05-26-2126-盘后数据自动化施工方案.md) §18.1 修正后的 M0 验收 / §20 实际交付回顾
>
...
- ⚠️ **`doc/design/05-26-2126-NewsTrading架构方案.md` §3 目标结构** 仍列 `curated_store.py`，与代码不一致（§5 已写 v2 单表，前后矛盾）
...
| 文档 | 问题 |
|------|------|
| `doc/design/05-26-2126-NewsTrading架构方案.md` §3 | 仍画 `curated_store.py` |
