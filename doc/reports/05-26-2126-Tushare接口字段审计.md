...
> Tushare 积分: **10000+**  
> 关联文档: [盘后数据自动化-功能说明.md](../features/05-26-2126-盘后数据自动化功能说明.md) · [盘后数据自动化-施工方案.md](../design/05-26-2126-盘后数据自动化施工方案.md)（施工时严格按本审计的字段名/单位/口径实现）
>
> **2026-05-28 16:00 迁移记录**：本文档自 `.huiye/_tushare_field_audit.md` 迁入 `doc/reports/`。理由：被 7 处 doc/ 正式文档引用（4 个施工方案 + 2 个 bugfix + 1 个 updates）+ 3 个 services/ 代码 docstring 引用，已超出 `.huiye/` 临时白名单语义，作为长期参考报告归档至此。详见 [工作目录第三批迁移日志](../updates/05-28-1600-工作目录第三批迁移.md)。
...
> 三源融合 v1 实测，参考 [doc/updates/05-27-1810-涨停三源融合上线.md](../updates/05-27-1810-涨停三源融合上线.md)
...
*本审计是 [盘后数据自动化-施工方案.md](../design/05-26-2126-盘后数据自动化施工方案.md) 的字段层依据。*  
